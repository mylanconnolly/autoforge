defmodule AutoforgeWeb.UsersLive do
  ...
  def mount(_params, _session, socket) do
    {:ok, assign(socket, page_title: "Users", query: "", sort: nil)}
  end
        ...
        <% else %>
          <.table>
            <.table_head>
              ...
              <:col>
                <.sort_header column="email" sort={@sort}>Email</.sort_header>
              </:col>
              <:col>
                <.sort_header column="timezone" sort={@sort}>Timezone</.sort_header>
              </:col>
              <:col></:col>
            </.table_head>
            <.table_body>
